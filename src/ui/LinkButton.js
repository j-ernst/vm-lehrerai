    ...
    return (
        <div>
            {disable ? (
                ...
                <Link href={link}>
                    <p
                        className="bg-black hover:bg-zinc-700 transition-transform duration-100 transform active:scale-95 px-4 py-2 text-center text-white rounded-md cursor-pointer"
                    >
                        {text}
                    </p>
                </Link>
